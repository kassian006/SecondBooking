    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_en', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='booking_app.city')),
                ('city_ru', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='booking_app.city')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_countres', to='booking_app.country')),
                ('country_en', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hotel_countres', to='booking_app.country')),
                ('country_ru', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hotel_countres', to='booking_app.country')),
